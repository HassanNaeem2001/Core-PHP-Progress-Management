...
if (isset($_POST['batchfilter'], $_POST['monthfilter'], $_POST['yearfilter'])) {
    ...
    SELECT sp.progressno, sp.*, s.enrollmentno, s.studentname, s.studentphoneno, 
           b.batchcode, st.staffname, MONTHNAME(sp.dateofprogress) AS month, 
           'Aptech Scheme 33' AS institute 
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_progress.php?id=<?php echo $record['progressno']; ?>" class="btn btn-warning">Edit</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
